...
export const Bird_PUZZLE: PuzzleDefinition = {
  ...
  shapes: [
    ...
    // bec = triangle 1/12
    { id:'beak-tri-1', kind:'twelfthg', x:67.7, y:48.2, r:60, color:'rgba(241,154,190)' },
...
// hexagone corps
    ...
    { id:'tail-seg-1', kind:'twelfthd', x:41.9, y:55.5, r:90, color:'rgba(241,154,190)' },
    { id:'tail-seg-2', kind:'twelfthd', x:36.5, y:59.5, r:-90, color:'rgba(241,154,190)' },
    { id:'tail-seg-3', kind:'twelfthd', x:41.9, y:59.5, r:90, color:'rgba(241,154,190)' },
